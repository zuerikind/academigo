export const de = {
  meta: {
    ...
    keywords: [
      "Academigo Schweiz",
      "Nachhilfe Schweiz",
      "Vor-Ort Nachhilfe Schweiz",
      "Mathematik Nachhilfe Schweiz",
      "Physik Nachhilfe",
      "Chemie Nachhilfe",
  ...
  dashboard: {
    ...
    stats: [
      ...
      { label: "Quiz", value: "8" },
      { label: "Streak", value: "5 Tage" },
    ],
    nextQuiz: "Nächstes Quiz",
    nextQuizTopic: "Quadratische Gleichungen",
    start: "Starten",
    overview: "Übersicht",
    errorAnalysis: "Fehleranalyse",
    feedbackTitle: "Sofortiges Feedback",
    feedbackBody: "Dein Rechenweg ist fast richtig — prüfe Schritt 3.",
    topics: [
      { topic: "Bruchrechnung", pct: 92 },
      { topic: "Gleichungen", pct: 68 },
