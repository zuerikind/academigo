export const en = {
  meta: {
    ...
    keywords: [
      ...
      "In-person tutoring Switzerland",
      "Math tutoring Switzerland",
      "Physics tutoring",
      "Chemistry tutoring",
      "Online tutoring Switzerland",
      "Gymnasium entrance exam prep",
  ...
  common: {
    brand: "Academigo",
    heroCtaTitle: "Get started",
    heroCtaSubtitle: "Open the platform, sign up directly, or view pricing",
    minutes: "minutes",
    ...
    buttons: {
      ...
      openPlatform: "Go to platform",
      registerHint: "Sign up directly at app.academigo.xyz",
      registerStudent: "Students & parents — sign up",
      registerTeacher: "Teachers — sign up",
  ...
  pricing: {
    ...
    subtitle:
      "All prices in CHF. One-time purchase — no subscriptions, no commitment.",
  ...
  dashboard: {
    ...
    nextQuiz: "Next quiz",
    nextQuizTopic: "Quadratic equations",
    start: "Start",
    overview: "Overview",
    errorAnalysis: "Error analysis",
    feedbackTitle: "Instant feedback",
    feedbackBody: "Your working is almost correct — check step 3.",
    topics: [
      { topic: "Fractions", pct: 92 },
      { topic: "Equations", pct: 68 },
